                    ...
                    $("tbody").contextmenu(function (key) {
                        setTimeout(function () {
                            ...
                            if (objProfile[0]['role'] == "เจ้าหน้าที่ (IVC)" && assige == "IVC") {
                                ...
                                if (Status_text == "Open") {
                                    $('.edit-detail').addClass('d-none').addClass('context-menu-disabled')
                                    $('.edit-detail-trp').removeClass('d-none').removeClass('context-menu-disabled')

                                } else {
                                    $('.edit-detail-trp').addClass('d-none').addClass('context-menu-disabled')
                                    $('.edit-detail').removeClass('d-none').removeClass('context-menu-disabled')
                            ...
                            if (user_id === 'ongkarn.s' || user_id === 'potjana.s' || user_id === 'kullanut.d' || user_id === 'narisara.k' || user_id === 'chutipon.b') {
